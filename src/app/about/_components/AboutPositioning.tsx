    ...
    <section style={{ padding: "80px 0", background: "#FFFFFF" }}>
      <div className="container" style={{ maxWidth: "1240px", margin: "0 auto", padding: "0 24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.1fr 0.9fr", gap: "48px", alignItems: "center", marginBottom: "70px" }}>
          <div>
            <div style={{ fontSize: "12px", fontWeight: "700", color: "#5B2E91", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: "8px" }}>
              OUR POSITIONING
            </div>
            <h2 style={{ fontFamily: "var(--font-montserrat), sans-serif", fontSize: "34px", fontWeight: "800", color: "#0B1F3A", letterSpacing: "-0.02em", marginBottom: "18px", lineHeight: "1.25" }}>
          ...
          <div style={{ background: "linear-gradient(135deg, #0B1F3A 0%, #5B2E91 100%)", borderRadius: "24px", padding: "40px", color: "#FFFFFF", boxShadow: "0 14px 40px rgba(91, 46, 145, 0.25)" }}>
        ...
        <div style={{ background: "#FAF8FF", border: "1.5px solid #EDE9FE", borderRadius: "24px", padding: "48px 36px", textAlign: "center" }}>
          <h3 style={{ fontSize: "28px", fontWeight: "800", color: "#0B1F3A", marginBottom: "10px" }}>
          ...
          <div style={{ display: "flex", gap: "16px", justifyContent: "center", flexWrap: "wrap" }}>
            <Link href="/#courses" style={{ background: "#5B2E91", color: "#FFFFFF", padding: "14px 28px", borderRadius: "12px", fontSize: "14px", fontWeight: "700", textDecoration: "none", boxShadow: "0 4px 14px rgba(91, 46, 145, 0.3)" }}>
              Explore Programs →
            </Link>
            <Link href="/cel" style={{ background: "#FFFFFF", border: "1.5px solid #5B2E91", color: "#5B2E91", padding: "14px 28px", borderRadius: "12px", fontSize: "14px", fontWeight: "700", textDecoration: "none" }}>
              See How CEL Works
            </Link>
          </div>
        </div>
