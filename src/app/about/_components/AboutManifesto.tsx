  ...
  return (
    <section style={{ padding: "80px 0", background: "#FAF8FF", borderTop: "1px solid #EDE9FE", borderBottom: "1px solid #EDE9FE" }}>
      <div className="container" style={{ maxWidth: "860px", margin: "0 auto", padding: "0 24px", textAlign: "center" }}>
        ...
        <div style={{ display: "inline-flex", alignItems: "center", gap: "6px", background: "#FFFFFF", border: "1px solid #EDE9FE", padding: "6px 16px", borderRadius: "9999px", color: "#6D28D9", fontSize: "12px", fontWeight: "700", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: "20px" }}>
          <span>📜</span> Our Manifesto
        </div>

        <div style={{ background: "#FFFFFF", padding: "48px 36px", borderRadius: "24px", border: "1.5px dashed #DDD6FE", boxShadow: "0 10px 30px rgba(109, 40, 217, 0.04)" }}>
