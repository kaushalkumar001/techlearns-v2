    ...
    <section style={{ padding: "80px 0 70px", background: "#FAF8FE" }}>
      <div className="container" style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          ...
          <h2 style={{ fontFamily: "var(--font-headings), sans-serif", fontSize: "clamp(34px, 4.2vw, 52px)", fontWeight: "900", color: "#0B1F3A", letterSpacing: "-0.02em", marginBottom: "14px" }}>
            The Environment Changes the Learner.
          </h2>
          <p style={{ fontSize: "16px", color: "#64748B", maxWidth: "760px", margin: "0 auto", lineHeight: "1.7" }}>
        ...
        >
          {environmentItems
            .filter(item => activeEnvTab === "All Practices" || item.category === activeEnvTab)
            .map((item, idx) => {
        ...
        >
          ...
          <h3 style={{ fontSize: "26px", fontWeight: "900", marginTop: "8px", marginBottom: "12px", color: "#FFFFFF" }}>
            Make Corporate Culture Familiar Before the First Job.
          </h3>
          <p style={{ fontSize: "15px", color: "#E2E8F0", maxWidth: "780px", margin: "0 auto", lineHeight: "1.65" }}>
