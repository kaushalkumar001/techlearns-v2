...
export default function BlogClientContent() {
  ...
  return (
    <main style={{ paddingBottom: "80px" }}>
      ...
      <section style={{ paddingTop: "0px", paddingBottom: "70px" }}>
        <div className="container">
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "24px", marginBottom: "44px" }}>
            <h1 className="blog-heading-serif" style={{ fontSize: "42px", fontWeight: 500, color: "var(--foreground)", whiteSpace: "nowrap", margin: 0 }}>
              Top Articles
            </h1>
            <div style={{ flex: 1, height: "1px", backgroundColor: "#CBD5E1", opacity: 0.8 }} />
            <span className="blog-heading-serif" style={{ fontSize: "38px", fontWeight: 500, color: "var(--foreground)" }}>
              2026
            </span>
          </div>
          ...
          <div className="blog-top-featured-grid">
            ...
            <div className="fade-in-up" style={{ display: "flex", flexDirection: "column" }}>
              <div style={{ position: "relative", width: "100%", height: "360px", borderRadius: "20px", overflow: "hidden", marginBottom: "20px" }}>
                <Image
              ...
              <h2 style={{ fontSize: "22px", fontWeight: 700, color: "var(--foreground)", lineHeight: "1.35", marginBottom: "12px", letterSpacing: "-0.01em" }}>
              ...
              <p style={{ fontSize: "14px", color: "var(--foreground-muted)", lineHeight: "1.6", marginBottom: "20px" }}>
              ...
              {secondaryFeaturedArticles.map((art, idx) => (
                <div key={idx} className="blog-secondary-item fade-in-up" style={{ animationDelay: `${(idx + 1) * 0.15}s` }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", justifyContent: "flex-start", paddingTop: "2px" }}>
                    ...
                    <h3 style={{ fontSize: "18px", fontWeight: 700, color: "var(--foreground)", lineHeight: "1.35", marginBottom: "12px", letterSpacing: "-0.01em" }}>
                      {art.title}
                    </h3>
      ...
      {/* Section 2: Sidebar & Articles Grid */}
